...
// require_once "/../../../functions/getTeachers.php";
?>
					...
					<div class="col-xl-4 col-xxl-6 col-md-6">
						<div class="card instructors-box">
							<div class="card-header border-0">
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-end">
										<a class="dropdown-item" href="../../../functions/delete.php">Delete</a>
										<a class="dropdown-item" href="../edit-teacher/<?php $teacher->id ?>;">Edit</a>
									</div>
								</div>
							</div>
								...
								<div class="instructors-media">
									...
									<div class="instructors-media-info">
										...
										<div class="d-flex justify-content-center my-3">
											...
											<div class="info-box">
												<span>
													<img src="images/svg/achievement.svg" alt="">
													Achievement
												</span>
												<h4>100</h4>
											</div>
							...
							<div class="card-footer pt-0 border-0">
								<a href="instructor-liveclass.html" class="btn btn-secondary  btn-block">View Profile</a>
							</div>
						</div>
					</div>
					<?php endforeach ?>
