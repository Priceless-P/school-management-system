...
// require_once "/../../../functions/editStudent.php";
?>
							...
							<div class="card-body text-center pb-3">
								<div class="instructors-media">
									...
									<div class="instructors-media-info mt-4">
										<h4 class="mb-1"><?php echo $student->fullname ?>?></h4>
								...
								<div class="achievements ">
									...
									<div class="achievements-content flex-wrap">
										<span><img src="images/svg/cup.svg"  alt=""></span>
							...
							<div class="col-xl-6 col-lg-6 col-sm-6">
								<div class="card profile-widget">
									<div class="card-body">
										<div class="widget-courses align-items-center d-flex justify-content-between style-1 flex-wrap">
											<div class="d-flex">
												<img src="images/svg/clock-1.svg"  alt="">
												<div class="ms-4">
													<h4>100</h4>
													<span>Progress</span>
												</div>	
